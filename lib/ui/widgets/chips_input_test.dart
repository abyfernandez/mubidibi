...
class TestChipsInput<T> extends StatefulWidget {
  const TestChipsInput({
    Key key,
...
class ChipsInputState<T> extends State<TestChipsInput<T>>
  ...
  @override
  void didUpdateWidget(TestChipsInput oldWidget) {
