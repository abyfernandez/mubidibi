...
class _StepperState extends State<MyStepper> with TickerProviderStateMixin {
  ...
  Widget _buildVerticalControls(int index) {
    ...
    return Container(
      margin: const EdgeInsets.only(top: 5.0), // 16
  ...
  Widget _buildVerticalHeader(int index) {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 0.0), // 10
      child: Row(
        children: <Widget>[
          Column(
            children: <Widget>[
          ...
          Expanded(
              child: Container(
            margin: const EdgeInsetsDirectional.only(start: 12.0), // 12
        ...
        AnimatedCrossFade(
          ...
          secondChild: Container(
            margin: const EdgeInsetsDirectional.only(
              start: 35.0, // 60  , start (margin) of field inside the step form
              end: 10.0, // 24
              bottom: 15.0, // 24
            ),
            child: Column(
