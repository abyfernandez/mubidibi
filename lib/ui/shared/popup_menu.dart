...
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class TPopupMenuItem<T> extends PopupMenuEntry<T> {
  ...
  @override
  PopupMenuItemState<T, TPopupMenuItem<T>> createState() =>
      PopupMenuItemState<T, TPopupMenuItem<T>>();
}
...
class PopupMenuItemState<T, W extends TPopupMenuItem<T>> extends State<W> {
...
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItem<T> extends TPopupMenuItem<T> {
...
class PopupMenuButtonState<T> extends State<TPopupMenuButton<T>> {
